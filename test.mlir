...
func.func @matmul(%arg0: memref<8192x8192xf32>, %arg1: memref<8192x8192xf32>,
                  %arg2: memref<8192x8192xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    affine.for %arg3 = 0 to 8192 {
      affine.for %arg4 = 0 to 8192 {
        affine.for %arg5 = 0 to 8192 {
          ...
          %2 = arith.mulf %0, %1 : f32
          %3 = affine.load %arg2[%arg5, %arg4] : memref<8192x8192xf32>
          %4 = arith.addf %3, %2 : f32
          affine.store %4, %arg2[%arg5, %arg4] : memref<8192x8192xf32>
        }
      }
    }
    return
